...
public class emailUtil {
    ...
    private static final String EMAIL_SENDER = "phamnguyentienmanh2004@gmail.com"; // Email gửi đi
    private static final String EMAIL_PASSWORD = "oqvqivfcusfyrkbp"; // Mật khẩu email
